...
namespace GGEngine {
    ...
    public:
        ...
        // Push constants (RHI handles)
        static void PushConstants(RHICommandBufferHandle cmd, RHIPipelineLayoutHandle layout, ShaderStage stageFlags,
